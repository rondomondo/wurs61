...
This repo contains a web-based implementation of the Wender Utah Rating Scale (WURS), a self-report assessment tool designed to help adults evaluate childhood behaviors associated with Attention Deficit Hyperactivity Disorder (ADHD). This is a common diagnostic checklist that is respected.
...
- Calculation of both total score and ADHD-specific subscore
- Immediate visual feedback with score interpretation, top and bottom
- Responsive design that works on desktop and mobile devices
- Highlighting of unanswered questions
- Score interpretation guidelines based on the research and source paper
...
3. Click the "Calculate Scores" button when you've completed all questions
4. Review your scores along with the interpretation
...
**Important Note**: This questionaire and my tool is for screening purposes only and cannot replace a formal diagnosis by a qualified healthcare professional. Please, please see a real professional if you feel the need.
...
This tool is provided for educational and personal use. The Wender Utah Rating Scale itself is a published assessment tool and should be used in accordance with professional and ethical guidelines.
